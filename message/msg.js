...
module.exports = async(hinata, msg, m, setting, store, welcome, left, set_welcome_db, set_left_db, db_respon_list, sewa, opengc, _afk, set_proses, set_done, set_open, set_close) => {
    try {
        ...
        let ytriy04 = 'https://youtube.com/c/Riy04'
...
*▸ Penyedia Dari :*
   ...
   *- Module*`
        ...
        case prefix+'sewabot': case prefix+'sewa':
            ...
            let butSewa = [
            { urlButton: { displayText: `Click Here!`, url : `https://wa.me/6281255090574` } }
            ]
...
Contoh:
${prefix}nuliskiri Riy 04`)
            break
        case prefix+'nuliskiri': {
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return replyDeface(`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            if (args.length < 2) return replyDeface(`Gunakan dengan cara ${command} text\n\nContoh : ${command} Riy 04`)
            replyDeface(mess.wait)
        ...
        case prefix+'couple': case prefix+'ppcouple':
          ...
          // Asupan Menu
            case prefix+'asupan':
                ...
                data = pickRandom(data)
                hinata.sendMessage(from, { caption: 'Jangan Lupa Subscribe : https://youtube.com/c/Riy0404', video: { url: data.url }}, { quoted: msg})
                limitAdd(sender, limit)
                break
            case prefix+'bocil':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
